...
class ProblemRatingCache(models.Model):
    ...
    provisional_rating = models.IntegerField(null=True, blank=True)
    provisional_confidence = models.FloatField(null=True, blank=True)
    provisional_source = models.CharField(max_length=80, blank=True, default='')
    provisional_updated_at = models.DateTimeField(null=True, blank=True)
...
class ScoreEvent(models.Model):
    ...
    rating_source = models.CharField(max_length=20, default='none', db_index=True)
    rating_is_provisional = models.BooleanField(default=False, db_index=True)
