...
CONTEST_PROBLEMS_START_BUFFER_MINUTES = config('CONTEST_PROBLEMS_START_BUFFER_MINUTES', default=3, cast=int)
CONTEST_PROBLEMS_RECENT_RETRY_WINDOW_HOURS = config('CONTEST_PROBLEMS_RECENT_RETRY_WINDOW_HOURS', default=12, cast=int)
CONTEST_PROBLEMS_RECENT_RETRY_MINUTES = config('CONTEST_PROBLEMS_RECENT_RETRY_MINUTES', default=3, cast=int)
CONTEST_PROBLEMS_ENQUEUE_ON_CATALOG = config('CONTEST_PROBLEMS_ENQUEUE_ON_CATALOG', default=True, cast=bool)
CONTEST_PROBLEMS_CATALOG_ENQUEUE_LIMIT = config('CONTEST_PROBLEMS_CATALOG_ENQUEUE_LIMIT', default=12, cast=int)
